...
export function StateToolbar({
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2.5 px-3 py-2 bg-white rounded-full shadow-md border border-neutral-200/80 text-[10px] font-medium">

        {/* Visibility pills — one per state */}
        <div className="flex items-center gap-1" role="group" aria-label="Toggle state visibility">
          {states.map(state => {
        ...
        <button
          ...
          className="px-2 py-1 text-neutral-500 hover:text-neutral-900 transition-colors duration-150"
        >
